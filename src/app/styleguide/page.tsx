  ...
  return (
    <main className="max-w-4xl mx-auto px-8 py-12">
      ...
      <div className="mb-12 text-lg text-slate-600">
        ...
        <p>
          Referências visuais que guiam nossa comunicação. Use como inspiração
          para manter a consistência em todas as peças.
        </p>
      </div>
        ...
        <div className="grid grid-cols-6 gap-4">
          {brandColors.map((color) => (
            ...
            >
              ...
              />
              <p className="text-xs text-[#57554C] font-mono ml-1 opacity-0 group-hover:opacity-100 transition-opacity">
